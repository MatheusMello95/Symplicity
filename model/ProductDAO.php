...
class ProductDAO extends DAO
{
    ...
    {
        $sql = "SELECT p.name, p.description, p.image, p.price, c.name FROM products as p 
        ...
        try {
            ...
            $stmt->execute();
            $products = $stmt->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, 'Product', ['p.name', 'p.description', 'p.image', 'p.price', 'c.name', 'p.id']);
